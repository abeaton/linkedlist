...
(0, _ava2.default)("Test constructor, null throws", function (t) {
	t.throws(_avaThrowsHelper(function () {
		return function () {
			new _linkedListNode2.default(null);
		};
	}, {
		line: 5,
		column: 10,
	...
	}), "The value passed into the constructor must not be defined.");
});
...
//# sourceMappingURL=../node_modules/.cache/ava/f92f0f8fd06466e93a0fb6535a97da21.js.map